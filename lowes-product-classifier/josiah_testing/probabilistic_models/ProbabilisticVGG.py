...
from bayesian_vgg import bayesian_vgg
...
flags.DEFINE_string("data_dir",
                    default=os.path.join("../../lowes-product-classifier/data"),
...
def build_input_pipeline(x_train, x_test, y_train, y_test,
  ...
  heldout_iterator = tf.data.Dataset.make_one_shot_iterator(heldout_batches)
